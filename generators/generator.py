...
for i in range(6, 50):
    ...
    obj = iDocument2D.ksCircle(i*5, 0, i*2, 1)
    iDefinition.EndEdit()
    ...
    print(iCollection.Last())
    #iCollection.SelectByPoint(-25.644166783143, 0, 0)
    ...
    obj.Create()
    kompas_document.SaveAs(rf"C:\u4ebaENG\Diplom-\DSet\Spins\ring_{i}.m3d")